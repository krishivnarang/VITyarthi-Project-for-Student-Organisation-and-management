# VITyarthi-Project-for-Student-Organisation-and-management
It is a project made to showcase my beginning skills and to achieve a real world example through the utilisation of real world example .
## Student Organisation and Management (SOM?)
A comprehensive Java SE console application for managing a campus's courses including it's student records , enrollments , and grades.
## Overview
SOM is a console-based Java application project which demonstrates Java programming concepts including:
...
# Features
### Core Functionality
- **Student Management**: Addition , Updation , List , and Deactivate students
- **Course Management**: Create, update, search courses by Instructor or Departmentor Semester
- **Enrollment Management**: Enrollment/Unenrollment of students with Credit Limit Validation checks
- **Grade Management**: Recording of marks , Computation of  GPA , Generatation of Transcripts
- **File Operations**: Import/Export CSV data , Backups with timestamps
- **What it Reports**: GPA distribution , Top students , Enrollment Statistics
### Technical Features
...
- **Polymorphism**: Abstract Person class with Student and Instructor implementations
...
|----------|---------|--------|--------------|
| **Java SE** | Standard Edition | Desktop / Server | Core API's , JVM , Development tools |
...
## Enabling Assertions
To enable assertions for the testing of invariants:
```cmd
...
## Sample Commands
### Basic Operations to Showcase Foundational mechanics
...
## Demo of Flow of program / application
...
## Acknowledgments
This project aims to demonstrate the comprehensive Java SE programming concepts as part of academic coursework regarding Programming in Java . All code is original work utilising and implementing standard Java patterns and practices.
